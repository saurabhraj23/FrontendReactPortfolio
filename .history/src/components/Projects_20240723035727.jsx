        ...
        <Link to={"https://github.com/saurabhraj23/Pruning"}>
          <button className="project-item">
            <span>
              <span className="skills">
                <span className="skill-heading">Skills Used :</span>
                <span>Python , Flask , HuggingFace-cli , Ubuntu-cli</span>
              </span>
              <span>
                The Project aimed to demonstrate the capabilities of Kortex in
                enhancing AI-based operations within KPMG.I was given the task
                to implement the User-Management Page,Pruning and Quantization
                of open source LLM Models.I successfully addressed the
                objectives by implementing user management functionalities and
                optimizing LLM models within Kortex,using pruning and
                quantisation.
              </span>
            </span>
