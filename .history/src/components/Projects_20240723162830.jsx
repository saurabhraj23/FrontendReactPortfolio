    ...
    <>
      ...
      <div className="projects-right-side">
        <Link to={"https://github.com/saurabhraj23/OnlineBankingAppKPMG"}>
          <button className="project-item BankingApp">
            <span>
              <span className="skills">
                <span className="skill-heading">Skills Used</span>
                <span>
                  Java , SpringBoot , React , Javascript , MYSQL , CSS , HTML
                </span>
              </span>
              <span>
                This Project was part of my KPMG Internship.In this I was
                assigned the task to implement security in the Web App.I have
                successfuly secured the app using RSA encryption technique.
              </span>
            </span>
        ...
        <Link to={"https://github.com/saurabhraj23/Glass-Portfolio"}>
          <button className="project-item glassmorphism">
            <span>
              <span className="skills">
                <span className="skill-heading">Skills Used :</span>
            ...
            <span>GlassPortfolio (Glassmorphism)</span>
          </button>
        </Link>
        <Link to={"https://github.com/saurabhraj23/Denoising-Image"}>
          <button className="project-item opencv">
            <span>
              <span className="skills">
                <span className="skill-heading">Skills Used</span>
        ...
        <Link to={"https://github.com/saurabhraj23/Pruning"}>
          <button className="project-item pruningLLM">
            <span>
              <span className="skills">
                <span className="skill-heading">Skills Used :</span>
              ...
              <span>
                ...
                completed the tasks assigned to me by implementing User
                Management functionalities , Optimizing and Prunining LLM models
                within Kortex.
              </span>
            </span>
